...
pizzas_and_toppings = [['Classic cheese', 'Pineapple island', 'Multitudinal of meat', 'mushroom and meats', 'vegan mix', '', ''],['', ''],['grated cheese', 'pineapple', 'ham', 'mushroom', 'olives', 'spinich', 'sliced onion', '']]
