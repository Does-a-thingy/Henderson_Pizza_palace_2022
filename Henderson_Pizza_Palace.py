...
pizzas_and_toppings = [['Classic cheese', 'Pineapple island', 'Multitudinal of meat', 'mushroom and meats', 'vegan mix', 'BBQ spice', ''], ['Dragons delight', '', '', '', ''], ['grated cheese', 'pineapple', 'ham', 'sliced mushroom', 'olives', 'spinich', 'sliced onion', 'grated carrot', 'grated vegan cheese', 'sliced jalapenos', 'sliced carolina reapers', '', '', '']]
